var indicatorModel = function (options) {
  ...
  if (this.indicatorId.includes('_1-')){
    ...
    var colors = ['e5b735', '927421', 'c5a754', '6d5719', 'd3bd7f', '493a10', 'e2d3a9', '241d08', 'f0e9d4'];
  }
    ...
    var colors = ['c5192d', '9d1424', 'd04656', '760f1b', 'dc7581', '4e0a12', 'e7a3ab', '270509', 'f3d1d5'];
  }
  else if(this.indicatorId.includes('_5-')){
    var colors = ['ff3a21', 'cc2e1a', 'ff614d', 'b22817', 'ff7563', '7f1d10', 'ff9c90', '330b06', 'ffd7d2'];
  }
  else if(this.indicatorId.includes('_6-')){
    var colors = ['26bde2', '1e97b4', '51cae7', '167187', '7cd7ed', '0f4b5a', 'a8e4f3', '07252d', 'd3f1f9'];
  }
  else if(this.indicatorId.includes('_7-')){
    var colors = ['fcc30b', 'c99c08', 'fccf3b', '977506', 'fddb6c', '644e04', 'fde79d', '322702', 'fef3ce'];
  }
  else if(this.indicatorId.includes('_8-')){
    var colors = ['a21942', '811434', 'b44667', '610f27', 'c7758d', '400a1a', 'd9a3b3', '20050d', 'ecd1d9'];
  }
  else if(this.indicatorId.includes('_9-')){
    var colors = ['fd6925', 'ca541d', 'fd8750', '973f16', 'fda57c', '652a0e', 'fec3a7', '321507', 'fee1d3'];
  }
  else if(this.indicatorId.includes('_10-')){
    var colors = ['dd1367', 'b00f52', 'e34285', '840b3d', 'ea71a3', '580729', 'f1a0c2', '2c0314', 'f8cfe0'];
  }
  else if(this.indicatorId.includes('_11-')){
    var colors = ['fd9d24', 'ca7d1c', 'fdb04f', '975e15', 'fdc47b', '653e0e', 'fed7a7', '321f07', 'feebd3'];
  }
  else if(this.indicatorId.includes('_12-')){
    var colors = ['c9992d', 'a07a24', 'd3ad56', '785b1b', 'dec181', '503d12', 'e9d6ab', '281e09', 'f4ead5'];
  }
  else if(this.indicatorId.includes('_13-')){
    var colors = ['3f7e44', '326436', '659769', '254b28', '8bb18e', '19321b', 'b2cbb4', '0c190d', 'd8e5d9'];
  }
  else if(this.indicatorId.includes('_14-')){
    var colors = ['0a97d9', '0878ad', '3aabe0', '065a82', '6cc0e8', '043c56', '9dd5ef', '021e2b', 'ceeaf7'];
  }
  else if(this.indicatorId.includes('_15-')){
    var colors = ['56c02b', '449922', '77cc55', '337319', '99d97f', '224c11', 'bbe5aa', '112608', 'ddf2d4'];
  }
  else if(this.indicatorId.includes('_16-')){
    var colors = ['00689d', '00537d', '3286b0', '003e5e', '66a4c4', '00293e', '99c2d7', '00141f', 'cce0eb'];
  }
  else if(this.indicatorId.includes('_17-')){
    var colors = ['19486a', '143954', '466c87', '0f2b3f', '7591a5', '0a1c2a', 'a3b5c3', '050e15', 'd1dae1'];
  }
  else{
